...
export const ABOUT_SHORT = `Full-Stack Developer with a Master's in Advanced Computer Science and 4+ years of building real-world, scalable systems.

I enjoy taking ideas from "this could be cool" to "this actually works in production." Whether it's crafting clean UIs or designing backend systems that don't break under pressure, I like building things that last.

I'm naturally curious and always experimenting with new technologies—not just to learn, but to understand what actually works in practice.

My focus is on writing code that's not just functional, but maintainable, observable, and easy to scale.

From APIs and authentication systems to data pipelines and deployment workflows, I like owning the full journey of a product.
...
export const PROJECTS: Project[] = [
  {
    ...
    desc: 'Built a production-ready full-stack boilerplate using Spring Boot, Angular, and MongoDB to accelerate scalable application development. Implemented secure authentication with granular role-based access control (RBAC) and multi-tenant architecture. Integrated logging, GitHub Actions CI/CD pipelines, and SonarQube for code quality and maintainability. Designed a modular, extensible foundation with UI-backend proxy setup for efficient development and future feature expansion.',
    livedemo: '',
