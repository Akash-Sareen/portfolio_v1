...
import { ABOUT_SHORT, ABOUT_LONG, STATS } from '../../data/portfolio';
        ...
        <div className={styles.grid}>
          ...
          <div className={`${styles.avatarCol} reveal`}>
            <div className={styles.avatarFrame}>
              ...
              <div className={styles.frameDot} style={{ top: 0, left: 0 }} />
              <div className={styles.frameDot} style={{ top: 0, right: 0 }} />
              <div className={styles.frameDot} style={{ bottom: 0, left: 0 }} />
              <div className={styles.frameDot} style={{ bottom: 0, right: 0 }} />
            </div>
          </div>
          ...
          <div className={styles.textCol}>
            <div className={styles.rulerBorder}>
              ...
              <p className={`${styles.body} reveal`}>{ABOUT_LONG}</p>
            </div>
